...
class ServerApi(object):
    ...
    def server_exception(self, data, **kwargs):  # noqa: E501
        """Saves an exception from a client on the server  # noqa: E501

        Sends logs to the ELK if it is connected  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.server_exception(data, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param Exception data: (required)
        :return: Exception
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def server_exception_with_http_info(self, data, **kwargs):  # noqa: E501
        """Saves an exception from a client on the server  # noqa: E501

        Sends logs to the ELK if it is connected  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.server_exception_with_http_info(data, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and (
            ...
            raise ValueError(
                "Missing the required parameter `data` when calling `server_exception`"
            )  # noqa: E501
    ...
    def server_logs(self, data, **kwargs):  # noqa: E501
        """Saves logs from a client on the server  # noqa: E501

        Sends logs to the ELK if it is connected  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.server_logs(data, async_req=True)
        >>> result = thread.get()

        :param async_req bool
        :param list[LogEvent] data: (required)
    ...
    def server_logs_with_http_info(self, data, **kwargs):  # noqa: E501
        """Saves logs from a client on the server  # noqa: E501

        Sends logs to the ELK if it is connected  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.server_logs_with_http_info(data, async_req=True)
        >>> result = thread.get()
        ...
        if self.api_client.client_side_validation and (
            ...
            raise ValueError(
                "Missing the required parameter `data` when calling `server_logs`"
            )  # noqa: E501
