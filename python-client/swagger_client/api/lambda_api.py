...
class LambdaApi(object):
    ...
    def lambda_functions_create_with_http_info(
        ...
        if self.api_client.client_side_validation and (
            "func_id" not in params or params["func_id"] is None
        ):  # noqa: E501
            raise ValueError(
        ...
        if self.api_client.client_side_validation and (
            "func_id" in params
            and not re.search(r"[a-zA-Z0-9_.-]+", params["func_id"])
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for parameter `func_id` when calling `lambda_functions_create`, must conform to the pattern `/[a-zA-Z0-9_.-]+/`"
            )  # noqa: E501
        collection_formats = {}
    ...
    def lambda_functions_read_with_http_info(
        ...
        if self.api_client.client_side_validation and (
            ...
            raise ValueError(
                "Invalid value for parameter `func_id` when calling `lambda_functions_read`, must conform to the pattern `/[a-zA-Z0-9_.-]+/`"
            )  # noqa: E501
        collection_formats = {}
