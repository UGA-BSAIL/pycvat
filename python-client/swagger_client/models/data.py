...
class Data(object):
    ...
    def chunk_size(self, chunk_size):
        ...
        if (
            ...
            and chunk_size > 2147483647
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `chunk_size`, must be a value less than or equal to `2147483647`"
            )  # noqa: E501
        if (
            self._configuration.client_side_validation
            and chunk_size is not None
            ...
            raise ValueError(
                "Invalid value for `chunk_size`, must be a value greater than or equal to `0`"
            )  # noqa: E501
    ...
    def size(self, size):
        ...
        if (
            ...
            raise ValueError(
                "Invalid value for `size`, must be a value less than or equal to `2147483647`"
            )  # noqa: E501
        if (
            self._configuration.client_side_validation
            and size is not None
            ...
            raise ValueError(
                "Invalid value for `size`, must be a value greater than or equal to `0`"
            )  # noqa: E501
    ...
    def image_quality(self, image_quality):
        ...
        if (
            ...
            and image_quality > 100
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `image_quality`, must be a value less than or equal to `100`"
            )  # noqa: E501
        if (
            self._configuration.client_side_validation
            and image_quality is not None
            ...
            raise ValueError(
                "Invalid value for `image_quality`, must be a value greater than or equal to `0`"
            )  # noqa: E501
    ...
    def start_frame(self, start_frame):
        ...
        if (
            ...
            and start_frame > 2147483647
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `start_frame`, must be a value less than or equal to `2147483647`"
            )  # noqa: E501
        if (
            self._configuration.client_side_validation
            and start_frame is not None
            ...
            raise ValueError(
                "Invalid value for `start_frame`, must be a value greater than or equal to `0`"
            )  # noqa: E501
    ...
    def stop_frame(self, stop_frame):
        ...
        if (
            ...
            and stop_frame > 2147483647
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `stop_frame`, must be a value less than or equal to `2147483647`"
            )  # noqa: E501
        if (
            self._configuration.client_side_validation
            and stop_frame is not None
            ...
            raise ValueError(
                "Invalid value for `stop_frame`, must be a value greater than or equal to `0`"
            )  # noqa: E501
    ...
    def frame_filter(self, frame_filter):
        ...
        if (
            self._configuration.client_side_validation
            and frame_filter is not None
            and len(frame_filter) > 256
        ):
            raise ValueError(
                "Invalid value for `frame_filter`, length must be less than or equal to `256`"
            )  # noqa: E501
    ...
    def compressed_chunk_type(self, compressed_chunk_type):
        ...
        if (
            self._configuration.client_side_validation
            and compressed_chunk_type not in allowed_values
        ):
            raise ValueError(
    ...
    def original_chunk_type(self, original_chunk_type):
        ...
        if (
            self._configuration.client_side_validation
            and original_chunk_type not in allowed_values
        ):
            raise ValueError(
