...
class DatasetFormats(object):
    ...
    def __init__(
        self, importers=None, exporters=None, _configuration=None
    ):  # noqa: E501
    ...
    def importers(self, importers):
        ...
        """
        if self._configuration.client_side_validation and importers is None:
            raise ValueError(
    ...
    def exporters(self, exporters):
        ...
        :type: list[DatasetFormat]
        """
        if self._configuration.client_side_validation and exporters is None:
            raise ValueError(
