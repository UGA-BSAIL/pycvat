...
class Segment(object):
    ...
    def __init__(
        self, start_frame=None, stop_frame=None, jobs=None, _configuration=None
    ):  # noqa: E501
    ...
    def start_frame(self, start_frame):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and start_frame is None:
            raise ValueError(
        ...
        if (
            self._configuration.client_side_validation
            and start_frame is not None
            and start_frame < -2147483648
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `start_frame`, must be a value greater than or equal to `-2147483648`"
            )  # noqa: E501
    ...
    def stop_frame(self, stop_frame):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and stop_frame is None:
            raise ValueError(
        ...
        if (
            self._configuration.client_side_validation
            and stop_frame is not None
            and stop_frame < -2147483648
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `stop_frame`, must be a value greater than or equal to `-2147483648`"
            )  # noqa: E501
