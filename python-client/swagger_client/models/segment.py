...
class Segment(object):
    ...
    def __init__(self, start_frame=None, stop_frame=None, jobs=None):  # noqa: E501
    ...
    def start_frame(self, start_frame):
        ...
        if start_frame is None:
            raise ValueError("Invalid value for `start_frame`, must not be `None`")  # noqa: E501
    ...
    def stop_frame(self, stop_frame):
        ...
        if stop_frame is None:
            raise ValueError("Invalid value for `stop_frame`, must not be `None`")  # noqa: E501
