...
class Plugins(object):
    ...
    def __init__(self, git_integration=None, analytics=None, models=None, predict=None):  # noqa: E501
    ...
    def git_integration(self, git_integration):
        ...
        if git_integration is None:
            raise ValueError("Invalid value for `git_integration`, must not be `None`")  # noqa: E501
    ...
    def analytics(self, analytics):
        ...
        if analytics is None:
            raise ValueError("Invalid value for `analytics`, must not be `None`")  # noqa: E501
