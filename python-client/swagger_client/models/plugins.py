...
class Plugins(object):
    ...
    def analytics(self, analytics):
        ...
        :type: bool
        """
        if self._configuration.client_side_validation and analytics is None:
            raise ValueError(
    ...
    def models(self, models):
        ...
        :type: bool
        """
        if self._configuration.client_side_validation and models is None:
            raise ValueError(
