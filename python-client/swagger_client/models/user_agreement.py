...
class UserAgreement(object):
    ...
    def display_text(self, display_text):
        ...
        if (
            ...
            and len(display_text) > 2048
        ):
            raise ValueError(
                "Invalid value for `display_text`, length must be less than or equal to `2048`"
            )  # noqa: E501
        if (
            self._configuration.client_side_validation
            and display_text is not None
            and len(display_text) < 1
        ):
            raise ValueError(
                "Invalid value for `display_text`, length must be greater than or equal to `1`"
            )  # noqa: E501
    ...
    def url(self, url):
        ...
        if (
            ...
            raise ValueError(
                "Invalid value for `url`, length must be less than or equal to `2048`"
            )  # noqa: E501
        if (
            self._configuration.client_side_validation
            and url is not None
