...
class CombinedIssue(object):
    ...
    def comment_set(self, comment_set):
        ...
        :type: list[Comment]
        """
        if self._configuration.client_side_validation and comment_set is None:
            raise ValueError(
    ...
    def frame(self, frame):
        ...
        if (
            ...
            and frame > 2147483647
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `frame`, must be a value less than or equal to `2147483647`"
            )  # noqa: E501
        if (
            self._configuration.client_side_validation
            and frame is not None
    ...
    def job(self, job):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and job is None:
            raise ValueError(
