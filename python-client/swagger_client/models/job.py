...
class Job(object):
    ...
    def __init__(self, url=None, id=None, assignee=None, assignee_id=None, reviewer=None, reviewer_id=None, status=None, start_frame=None, stop_frame=None, task_id=None):  # noqa: E501
