...
class Attribute(object):
    ...
    def __init__(self, id=None, name=None, mutable=None, input_type=None, default_value=None, values=None):  # noqa: E501
    ...
    def mutable(self, mutable):
        ...
        """
        if mutable is None:
            raise ValueError("Invalid value for `mutable`, must not be `None`")  # noqa: E501
    ...
    def input_type(self, input_type):
        ...
        allowed_values = ["checkbox", "radio", "number", "text", "select"]  # noqa: E501
