...
class Attribute(object):
    ...
    def mutable(self, mutable):
        ...
        :type: bool
        """
        if self._configuration.client_side_validation and mutable is None:
            raise ValueError(
    ...
    def input_type(self, input_type):
        ...
        :type: str
        """
        if self._configuration.client_side_validation and input_type is None:
            raise ValueError(
        ...
        if (
            self._configuration.client_side_validation
            and input_type not in allowed_values
        ):
            raise ValueError(
    ...
    def default_value(self, default_value):
        ...
        if (
            ...
            and len(default_value) > 128
        ):
            raise ValueError(
                "Invalid value for `default_value`, length must be less than or equal to `128`"
            )  # noqa: E501
        if (
            self._configuration.client_side_validation
            and default_value is not None
            ...
            raise ValueError(
                "Invalid value for `default_value`, length must be greater than or equal to `1`"
            )  # noqa: E501
    ...
    def values(self, values):
        ...
        if (
            ...
            raise ValueError(
                "Invalid value for `values`, length must be less than or equal to `4096`"
            )  # noqa: E501
        if (
            self._configuration.client_side_validation
            and values is not None
            ...
            raise ValueError(
                "Invalid value for `values`, length must be greater than or equal to `1`"
            )  # noqa: E501
