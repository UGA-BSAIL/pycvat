...
class TrackedShape(object):
    ...
    def __init__(self, type=None, occluded=None, z_order=None, points=None, id=None, frame=None, outside=None, attributes=None):  # noqa: E501
    ...
    def outside(self, outside):
        ...
        """
        if outside is None:
            raise ValueError("Invalid value for `outside`, must not be `None`")  # noqa: E501
