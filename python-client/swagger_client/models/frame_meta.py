...
class FrameMeta(object):
    ...
    def __init__(self, width=None, height=None, name=None, has_related_context=None):  # noqa: E501
    ...
    def has_related_context(self, has_related_context):
        ...
        if has_related_context is None:
            raise ValueError("Invalid value for `has_related_context`, must not be `None`")  # noqa: E501
