...
class AttributeVal(object):
    ...
    def __init__(
        self, spec_id=None, value=None, _configuration=None
    ):  # noqa: E501
    ...
    def spec_id(self, spec_id):
        ...
        :type: int
        """
        if self._configuration.client_side_validation and spec_id is None:
            raise ValueError(
    ...
    def value(self, value):
        ...
        if (
            ...
            raise ValueError(
                "Invalid value for `value`, length must be less than or equal to `4096`"
            )  # noqa: E501
