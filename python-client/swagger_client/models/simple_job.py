...
class SimpleJob(object):
    ...
    def assignee(self, assignee):
        ...
        :type: BasicUser
        """
        if self._configuration.client_side_validation and assignee is None:
            raise ValueError(
                "Invalid value for `assignee`, must not be `None`"
            )  # noqa: E501
    ...
    def assignee_id(self, assignee_id):
        ...
        if self._configuration.client_side_validation and assignee_id is None:
            raise ValueError(
                "Invalid value for `assignee_id`, must not be `None`"
            )  # noqa: E501
