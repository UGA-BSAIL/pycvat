...
class DataMeta(object):
    ...
    def frame_filter(self, frame_filter):
        ...
        if (
            ...
            and len(frame_filter) < 1
        ):
            raise ValueError(
                "Invalid value for `frame_filter`, length must be greater than or equal to `1`"
            )  # noqa: E501
    ...
    def frames(self, frames):
        ...
        :type: list[FrameMeta]
        """
        if self._configuration.client_side_validation and frames is None:
            raise ValueError(
