...
class CombinedReview(object):
    ...
    def __init__(self, id=None, assignee=None, assignee_id=None, reviewer=None, reviewer_id=None, issue_set=None, estimated_quality=None, status=None, job=None):  # noqa: E501
    ...
    def issue_set(self, issue_set):
        ...
        if issue_set is None:
            raise ValueError("Invalid value for `issue_set`, must not be `None`")  # noqa: E501
    ...
    def estimated_quality(self, estimated_quality):
        ...
        if estimated_quality is None:
            raise ValueError("Invalid value for `estimated_quality`, must not be `None`")  # noqa: E501
    ...
    def status(self, status):
        ...
        allowed_values = ["accepted", "rejected", "review_further"]  # noqa: E501
