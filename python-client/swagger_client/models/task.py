...
class Task(object):
    ...
    def mode(self, mode):
        ...
        if (
            ...
            raise ValueError(
                "Invalid value for `mode`, length must be greater than or equal to `1`"
            )  # noqa: E501
    ...
    def bug_tracker(self, bug_tracker):
        ...
        if (
            self._configuration.client_side_validation
            and bug_tracker is not None
            and len(bug_tracker) > 2000
        ):
            raise ValueError(
                "Invalid value for `bug_tracker`, length must be less than or equal to `2000`"
            )  # noqa: E501
    ...
    def overlap(self, overlap):
        ...
        if (
            ...
            and overlap > 2147483647
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `overlap`, must be a value less than or equal to `2147483647`"
            )  # noqa: E501
        if (
            self._configuration.client_side_validation
            and overlap is not None
            ...
            raise ValueError(
                "Invalid value for `overlap`, must be a value greater than or equal to `0`"
            )  # noqa: E501
    ...
    def segment_size(self, segment_size):
        ...
        if (
            ...
            and segment_size > 2147483647
        ):  # noqa: E501
            raise ValueError(
                "Invalid value for `segment_size`, must be a value less than or equal to `2147483647`"
            )  # noqa: E501
        if (
            self._configuration.client_side_validation
            and segment_size is not None
            ...
            raise ValueError(
                "Invalid value for `segment_size`, must be a value greater than or equal to `0`"
            )  # noqa: E501
